...
const double mtau=1.77699;		// Masse du tau en GeV
const double mmuon=0.10566;		// Masse du muon en GeV
const double le=3.8616*1e-11;		// Longueur d'onde de Compton de l'�lectron / 2PI
const double Navo=6.02214199*1e+23;	// Nombre d'Avogadro
const double me=0.510998902*1e-3;	// Masse de l'�lectron en GeV
...
const double aa=0.083;	//   Param�tres pour le calcul de l'ionisation
const double mm=3.412;	//
const double I=136.4*1e-9;	//
const double I2=I*I;		//
const double CC=-3.774;	//

const double densrock=2.65; 	// densit� moyenne du milieu en g/cm^3

// Constantes utilis�es dans le calcul de la perte par ionisation

const double Cbb1=a2*2*PI*Navo*le*le*Z*me/A;
const double Cbb2=2*me;

// Param�tres de la param�trisation pour le beta total (effet photonucl�aire + brem + production de paire): 
// Polynome de degr� 9 entre 100 GeV et 10e14 GeV  (pour la roche standard)
...
// Param�tres pour le calcul de la section efficace totale de l'interaction CC: 
// Polynome de degr� 7 entre 10e5 et 10e12 GeV
...
// Param�tres pour le calcul de la section efficace totale de l'interaction NC: 
// Polynome de degr� 9 entre 10e5 et 10e12 GeV
