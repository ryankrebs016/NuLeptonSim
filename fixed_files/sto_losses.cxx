...
class stochastic_lepton_prop
{
    ...
    string muon_ice_table_dir=table_dir;
    string muon_rock_table_dir=table_dir;
    string tau_ice_table_dir=table_dir;
    string tau_ice_table_dir=table_dir;

    muon_ice_table_dir +="new_tables/muon_txt_1e-4_ice";
    muon_rock_table_dir +="new_tables/muon_txt_1e-4_rock";
    tau_ice_table_dir +="new_tables/tau_txt_1e-4_ice";
    tau_ice_table_dir +="new_tables/tau_txt_1e-4_ice";
